...
function masterMode(event) {
  ...
  var DrillingNodes = [
    ...
    'AGENT.OBJECTS.IVE50.Well.DrillSpeed.DrillSpeedRaw',
...
webMI.data.subscribe('AGENT.OBJECTS.ASPD.Mode_Signals.APD1_Optimal_Drill_On', function (e) {
  var id = 'id_Optimum';
...
webMI.data.subscribe(
  'AGENT.OBJECTS.ASPD.Mode_Signals.Tool_Drillstem_Torque_Smoothing_DBTool_Drillstem_Torque_Smoothing_DB',
  function (e) {
    var id = 'id_Dempfer';
...
//* Нагрузка
webMI.data.subscribe('AGENT.OBJECTS.IVE50.Drawworks.LoadOnBit.LoadOnBitRaw', function (e) {
  var id = 'id_20';
  var value = e.value;

  console.log('LOB', value);

  webMI.gfx.setText(id, webMI.sprintf('%.1f', value));
});

webMI.data.subscribe('AGENT.OBJECTS.IVE50.Mud.Pump.DiffPressure', function (e) {
  //? Переменная до - AGENT.OBJECTS.ASPD.APD1.Diff_Pressure.PID.Inputs.Input
...
webMI.data.subscribe(
  'AGENT.OBJECTS.ASPD.Drawworks.HookBlock.Position.Limit_High_Warning',
  function (e) {
    var id = 'id_60';
    var value = e.value;
...
webMI.data.subscribe(
  'AGENT.OBJECTS.ASPD.Drawworks.HookBlock.Position.Limit_Low_Warning',
  function (e) {
    var id = 'id_62';
    var value = e.value;
